...
// Tiny global Leaflet wrapper. We render markers from props and clean up on unmount.
...
// Mini map: used on dashboard + on profile sidebar.
...
const MapPage = ({ t, lang, data, go }) => {
  ...
  // Combined sorted list for sidebar
  const items = [
