...
const Home = ({ t, lang, data, go }) => {
  ...
  // Recently added (use lastContact as proxy for "recent activity")
  const recentPersonas = [...personas].sort((a, b) => (b.lastContact || "").localeCompare(a.lastContact || "")).slice(0, 5);

  // Upcoming birthdays (next 60 days from now)
  ...
  // People by role (use first/main role)
  const roleCounts = {};
